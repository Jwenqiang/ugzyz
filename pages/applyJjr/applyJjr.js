...
Page({
  ...
  rz(){
    ...
    if (that.data.name==''){
      ...
      wx.request({
        url: 'https://spapi.centaline.com.cn/zyzapi/Users/UserIsAgentrz',
        method:"post",
        header:{
  ...
  getUser(){
    ...
    wx.request({
      url: 'https://spapi.centaline.com.cn/zyzapi/Users/GetUser',
  ...
  getData() {
    var that = this;
    wx.request({
      url: 'https://spapi.centaline.com.cn/zyzapi/System/GetSystemConfigByKey',
      data: { Key: 2 },
      success: res => {
        console.log(res);
        if (res.data.code == 1001) {
  ...
  saveMsg(e) {
    ...
    wx.getFileSystemManager().readFile({
      ...
      success: r => { //成功的回调
        ...
        wx.request({
          url: 'https://spapi.centaline.com.cn/zyzapi/System/PostImgByBase64',
          method: "post",
          data: {
            ImgBase64: baseUrl
          },
